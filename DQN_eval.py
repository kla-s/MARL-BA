...
def get_player(directory=None, files_list=None, viz=False,
    ...
    env = MedicalPlayer(directory=directory, screen_dims=IMAGE_SIZE,
                        ...
                        reward_strategy=reward_strategy, coords_init=coords_init, mask=mask)
    if (task != 'train'):
    ...
    return TrainConfig(
        ...
        callbacks=[
            ...
            ScheduledHyperParamSetter(
                ...
                interp='linear'),
            PeriodicTrigger(
                # TODO: does this call of get_player need mask and init_coords?
...
if __name__ == '__main__':
    ...
    parser.add_argument('--load', help='load model',
                        default='/vol/biomedic2/av2514/PycharmProjects/DEVLandmarkDetection/DQN/train_log/Cardiac_with_19points/model-350000')
    ...
    '/vol/biomedic2/aa16914/shared/thanos/data/cardiac_test_files_copy.txt',
    '/vol/biomedic2/aa16914/shared/thanos/data/cardiac_test_landmarks_copy.txt'),
    ...
    init_player = MedicalPlayer(files_list=args.files,
                                ...
                                coords_init=args.coords_init, mask=args.mask_roi)
    ...
    if args.task != 'train':
        ...
        config = get_config(args.files, input_names=state_names,
                            ...
                            coords_init=args.coords_init, mask=args.mask)
